...
public class StreetViewService extends JavaScriptObject {
    ...
    /**
     * Use newInstance(). This method has been spelled incorrectly. Deprecated
     * on 1/26/2013. Deprecate in 3.11
     */
    @Deprecated
    ...
    private static final void getPanoramaByIdImpl(StreetViewPanoramaData data,
                                                  String status, PanoramaIdHandler handler) {
        handler.onCallback(data, StreetViewStatus.fromValue(status));
    }

    private static final void getPanoramaByLocationImpl(
            StreetViewPanoramaData data, String status,
     ...
     * @param handler
     */
    public final native void getPanoramaById(String pano,
     ...
     * @param handler
     */
    public final native void getPanoramaByLocation(LatLng latlng,
                                                   double radius, PanoramaByLocationHandler handler) /*-{
        var callback = function (data, status) {
