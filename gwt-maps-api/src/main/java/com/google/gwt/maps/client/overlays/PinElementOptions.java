...
/**
 * Options for {@link PinElement}.
 */
public class PinElementOptions extends JavaScriptObject {

  protected PinElementOptions() {
  }

  public final static PinElementOptions newInstance() {
