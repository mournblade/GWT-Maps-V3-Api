...
import com.google.gwt.maps.client.placeslib.placeresult.PlaceResultPhotos;
...
public class PlaceResult extends JavaScriptObject {
     ...
     */
    public final native void setAddress_Components(
     ...
     */
    public final native void setFormatted_Phone_Number(
    ...
    /**
     * A unique identifier denoting this Place. This identifier may not be used
     * to retrieve information about this Place, and to verify the identity of a
     * Place across separate searches. As ids can occasionally change, it is
     * recommended that the stored id for a Place be compared with the id
     * returned in later Details requests for the same Place, and updated if
     * necessary.
     */
     ...
     * includes the country code, and is prefixed with the plus (+) sign.
     */
    public final native void setInternational_Phone_Number(
    ...
    /**
     * An opaque string that may be used to retrieve up-to-date information
     * about this Place (via PlacesService.getDetails()). reference contains a
     * unique token that you can use to retrieve additional information about
    ...
    /**
     * An array of types for this Place (e.g., ["political", "locality"] or
    ...
    /**
     * A fragment of the Place's address for disambiguation (usually street name
     * and locality).
     */
    ...
    /**
     * Reviews an array of up to five reviews. Each review consists of several
     * components:
     */
     ...
     * Photos reference
     */
    public final native JsArray<PlaceResultPhotos> getPhotos() /*-{
        return this.photos;
    }-*/;
